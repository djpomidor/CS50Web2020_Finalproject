# Generated by Django 4.0.2 on 2022-03-20 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owners', models.ManyToManyField(blank=True, related_name='order_owners', to=settings.AUTH_USER_MODEL)),
                ...
                ('paper_insert', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='insert_paper', to='printery.paper')),
            ],
        ),
        migrations.AddField(
            model_name='user',
