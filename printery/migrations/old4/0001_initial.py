# Generated by Django 4.0.2 on 2022-03-20 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('binding', models.CharField(blank=True, choices=[('GLU', 'Glue'), ('STA', 'Staple'), ('HAR', 'Hardcover'), ('FOL', 'Folding')], max_length=3)),
                ('width', models.IntegerField(blank=True, null=True)),
                ('height', models.IntegerField(blank=True, null=True)),
                ('pages_in_block', models.IntegerField(blank=True, null=True)),
                ('pages_in_cover', models.IntegerField(blank=True, null=True)),
                ('pages_in_insert', models.IntegerField(blank=True, null=True)),
                ...
                ('paper_block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='block_paper', to='printery.paper')),
                ('paper_cover', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cover_paper', to='printery.paper')),
                ('paper_insert', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='insert_paper', to='printery.paper')),
            ],
        ),
        migrations.AddField(
            model_name='user',
